...
(function() {
  ...
  hm.src = "//hm.baidu.com/hm.js?2b4c34c2be8d8855ef58504465e865f1";
  ...
  s.parentNode.insertBefore(hm, s);
	...
	function hz6d_cus_web_msg_open(){
		var openurl = "http://www10.53kf.com/webCompany.php?arg=10055423&style=1&kflist=off&kf=833910&zdkf_type=3&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.heivr.com%2FChaojijiaoshi%2F&keyword=&brief=&logo=&question=&uid=8a084ff8810535d3474cd948a7988ec6";
		try{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "0";
			var ivtstr						= "<div id=\"acc_title\" style=\"    position: relative; z-index: 10000; cursor: pointer;\" minheight=\"100\" minwidth=\"100\" maxheight=\"400\" maxwidth=\"400\" class=\"Lelem\" operating=\"null\"><div style=\"display: block; cursor: pointer; position: absolute; top: 6px; left: 4px; z-index: 10001; width: 285px; height: 187px;\" type=\"img\" class=\"Lelem\" operating=\"null\"><img src=\"http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/common_bg_inv/commonbg_9.png\" style=\"width: 285px; height: 187px;\"></div><div style=\"display: block; cursor: pointer; position: absolute; top: 23px; left: 60px; z-index: 10002; width: 141px; height: 23px; color: rgb(255, 255, 255);\" type=\"text\" class=\"Lelem\" operating=\" \"><span style=\"vertical-align: top; font-size: 16.1px; line-height: 23px; color: rgb(255, 255, 255); font-weight: bold; font-family: 黑体;\" iseditable=\"1\">黑晶在线客服</span></div><div style=\"display: block; cursor: pointer; position: absolute; top: 24px; left: 253px; z-index: 10003; width: 22px; height: 22px;\" operating=\"CLOSE\" type=\"img\" class=\"Lelem\"><img src=\"http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/close_btn/closebtn_8.png\" style=\"width: 22px; height: 22px;\"></div><div style=\"display: block; cursor: default; position: absolute; top: 57px; left: 30px; z-index: 10004; width: 112px; height: 23px; color: rgb(255, 255, 255);\" type=\"text\" class=\"Lelem\" operating=\" \"><span style=\"vertical-align: top; font-size: 16.1px; line-height: 23px; color: rgb(255, 255, 255); font-family: 黑体; font-weight: bold;\" iseditable=\"1\">欢迎咨询！</span></div><div style=\"display: block; cursor: default; position: absolute; top: 83px; left: 28px; z-index: 10006; width: 166px; height: 17px; color: rgb(255, 255, 255);\" type=\"text\" class=\"Lelem\" operating=\" \"><span style=\"vertical-align: top; font-size: 11.9px; line-height: 17px; color: rgb(255, 255, 255); font-family: 宋体;\" iseditable=\"1\">请问有什么可以帮您？</span></div><div style=\"display: block; cursor: pointer; position: absolute; top: 109px; left: 28px; z-index: 10007; width: 100px; height: 31px;\" operating=\"KF\" type=\"img\" class=\"Lelem\"><img src=\"http://www10.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_46.png\" style=\"width: 100px; height: 31px;\"></div><div style=\"display: block; cursor: pointer; position: absolute; top: 115px; left: 144px; z-index: 10008; width: 60px; height: 17px; color: rgb(255, 255, 255);\" type=\"text\" class=\"Lelem\" operating=\"CLOSE\"><span style=\"vertical-align: top; text-decoration: underline; font-family: 黑体; font-size: 11.9px; line-height: 17px; color: rgb(255, 255, 255);\" iseditable=\"1\">下次再说</span></div></div>";
			var is_autoyqk				= "1";
			...
			$53.creElm({
				...
				tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
									'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 42px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
										'<img style="width:24px;height:24px;position:absolute;left:10px;top:6px;border-radius:2px;" src="http://www10.53kf.com/img/upload/10055423/mobile/temp/mobile_53kf_1510802962.png"/>'+
	...
	//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑  2017版访客端新增 ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
			...
			{
				var openurl = "http://www10.53kf.com/webCompany.php?arg=10055423&style=1&kflist=off&kf=833910&zdkf_type=3&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.heivr.com%2FChaojijiaoshi%2F&keyword=&brief=&logo=&question=&uid=8a084ff8810535d3474cd948a7988ec6&tfrom=2"+force_kf;
				try{
			...
			function max_min_company_mini(t)
			{
				if (t.getAttribute('max_min') == 'max')
				{
                    ...
                    $53("div_company_mini").style.right = '0px';
			     	$53("div_company_mini").style.bottom = '0px';                    $53("mini_header_bg_div").style.backgroundImage = "url('http://www10.53kf.com/style/chat/minichat2/img/header_bg2_7.png')";
				}
				else
				{
				...
				}                   $53("mini_header_bg_div").style.backgroundImage = "url('http://www10.53kf.com/style/chat/minichat2/img/header_bg_7.png')";
			...
			{
				if(zdfq_switch == 'yes') {
					//document.cookie = "onliner_zdfq72055423="+onliner_zdfq;
					document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
				} else {
					document.cookie = "my_acc_reauto_time=null;path=/";
				}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				try{
					...
					if(type==1){
						...
						if('1' == 0){
							...
							$53("iframe_company_mini").src = openurl_mini + tpl + '&timeStamp=' + new Date().getTime()+'&interface_color=7&interface_theme=7&minchat_style=1';
			...
			function close_company_mini(){
                ...
                if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72055423="+onliner_zdfq;}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF':
								var click_open_url = 'window.open(\"http://www10.53kf.com/webCompany.php?arg=10055423&style=1&kflist=off&kf=833910&zdkf_type=3&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.heivr.com%2FChaojijiaoshi%2F&keyword=&brief=&logo=&question=&uid=8a084ff8810535d3474cd948a7988ec6&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								...
								break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"http://www10.53kf.com/webCompany.php?arg=10055423&style=1&kflist=off&kf=833910&zdkf_type=3&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.heivr.com%2FChaojijiaoshi%2F&keyword=&brief=&logo=&question=&uid=8a084ff8810535d3474cd948a7988ec6&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE':
								click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
							case 'ETEL':
								click_str = 'window.open(\'http://tb.53kf.com/eht.php?company_id=72055423&style_id=106083846\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
							case 'QQ':
								if(valst[1]){
